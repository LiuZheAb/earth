...
import { Rendering, Screen, reassignManipulators, 
    // changeManipulators, 
    showBoundRuler, gl, Axis } from "../common/index"
...
export default class mshView extends Component {
    ...
    render() {
        let { boxBgColor, model, mode, modeBounds, bounds, 
            // light, axis 
        } = this.state;
        ...
        //改变显示样式
        // changeManipulators(model, moveStyle, "LINE", light, axis);
        console.log({ moveStyle, modelStyle });
        //截屏
