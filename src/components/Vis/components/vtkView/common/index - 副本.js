...
//创建平面
export const creatPlane = (model, _this, xAxis, yAxis, datatype, arrs, xLength, yLength, actor, mapper, lookupTable, data, cen) => {
    let array = [], array1 = [];
    //去重
    ...
    actor.setMapper(mapper);
    let pointDatas = [...actor.getMapper().getInputData().getPointData().getScalars().getData()];
